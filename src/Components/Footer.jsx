...
function Footer() {
  return (
    <div style={{ height: '300px',backgroundColor:"greenyellow", }} className=' w-100 mt-5'>
      <div className="container footer-content d-flex justify-content-between">
        ...
        <div className="guides d-flex flex-column mt-5">
          <h3>Guides</h3>
          <a  className='text-decoration-none'style={{color:"black"}} href="" >React</a>
          <a className='text-decoration-none' style={{color:"black"}} href="">React Bootstrap</a>
          <a  className='text-decoration-none' style={{color:"black"}} href="">React Routing</a>
        </div>
